...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/shop_manager/shop/shop.css') }}">
@endsection
                        ...
                        <tr class="reservationList-table__row">
                            ...
                            <td class="reservationList-table__item">
                                <button class="reservationList-table__btn">
                                    <a class="reservationList-table__btn--detail" href="{{ route('shop-manager.reservation.show', $reservation->id) }}"><i class="fa-solid fa-pen-to-square"></i> 編集</a>
                                </button>
                            </td>
                        </tr>
                    @endforeach
