...
@section('content')
    ...
    <div class="shopManager-search">
        <form method="GET" action="{{ route('admin.shop-managers.index') }}" class="shopManager-search-form">
            @csrf
            <div class="shopManager-search-form__inner">
                ...
                <div class="shopManager-search-form_btns">
                    <div class="shopManager-search-form_btn">
                        <a class="shopManager-search-form_btn--reset" href="{{ route('admin.shop-managers.index') }}"><i class="fa-solid fa-rotate-right"></i> リセット</a>
                    </div>
                    <div class="shopManager-search-form_btn">
    ...
    <div class="admin-index__shopManager-create-btn">
        <a class="shopManager-create-btn__link" href="{{ route('admin.shop-managers.create') }}"><i class="fa-solid fa-plus"></i> 新規作成</a>
    </div>
                        ...
                        <tr class="shopManagers-table__row">
                            ...
                            <td class="shopManagers-table__item">
                                <button class="shopManagers-table__btn">
                                    <a class="shopManagers-table__btn--detail" href="{{ route('admin.shop-managers.show', $shopManager->id)}}"><i class="fa-solid fa-pen-to-square"></i> 詳細</a>
                                </button>
                            </td>
                        </tr>
                    @endforeach
